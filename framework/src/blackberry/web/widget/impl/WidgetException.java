        ...
        switch( _code ) {
            case ERROR_NETWORK_NOT_AVAILABLE:
                return "The radio on the device is currently turned off or the battery "
                        ...
                        + "resource could not be retrieved - " + _url + "\n\nPlease turn the radio on or "
                        + "recharge the battery and try again.  Contact your service provider " + "if this problem persists.";
            ...
            case ERROR_INSUFFICIENT_COVERAGE:
                return "You are not currently in an area that can handle data communication.  "
                        + "As a result, the following resource could not be retrieved - " + _url + ".\n\nPlease "
            ...
            case ERROR_WHITELIST_FAIL:
                return "The resource - " + _url + " - could not be retrieved because it was not found in the config.xml.\n\n"
