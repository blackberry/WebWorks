...
public abstract class WidgetConfigImpl implements WidgetConfig {
    ...
    // Provided by WidgetConfigImpl file - parsed/populated by Web Component Pack generated file
    ...
    protected Hashtable             _notifications;         // Key: name of the profile. Value: unique for registering the profile
    ...
    protected Hashtable             _allowedUriTypes;         // Key: file extension. Value: mime type
    ...
    protected WidgetConfigImpl() {
        ...
        _allowedUriTypes = null; // if _allowedUriTypes is null, all Uri types are cacheable
    }
    
    // implementation - net.rim.device.api.web.WidgetConfig
    public String               getAuthor() { return _author; }
    public String               getAuthorEmail() { return _authorEmail; }
    public String               getAuthorURL() { return _authorURL; }
    public String               getCopyright() { return _copyright; }
    public String               getContent() { return _content; }
    public String               getContentCharset() { return _contentCharset; }
    public String               getContentType() { return _contentType; }
    public HttpHeaders          getCustomHeaders() { return _customHeaders; }
    public String               getDescription() { return _description; }
    public Enumeration          getExtensions() { return _widgetExtensions.elements(); }
    public WidgetExtension      getExtensionForFeature(String featureID) { return (WidgetExtension) _featureTable.get(featureID); }
    public String               getIcon() { return _icon; }
    public String               getIconHover() { return _iconHover; }
    public String               getID() { return _id; }
    public String               getLicense() { return _license; }
    public String               getLicenseURL() { return _licenseURL; }
    public String               getName() { return _name; }    
    public Hashtable            getNotifications() { return _notifications; }
    public String               getVersion() { return _version; }    
    public String               getLoadingScreenColor() { return _loadingScreenColor; }    
    public int[]                getPreferredTransports() { return _preferredTransports; }    
    public Integer              getTransportTimeout() { return _transportTimeout; }
    ...
    public boolean              getRemotePageLoad() { return _remotePageLoad; }
    public boolean              getLocalPageLoad() { return _localPageLoad; }
    ...
    public int                  getOverrodeAge() { return _overrodeAge; }
    public int                  getMaxCacheable() { return _maxCacheable; }
    ...
    public String                               getForegroundSource() { return _foregroundSource; }
    
    public boolean                              isDebugEnabled() { return _debugEnabled; }
    ...
    /**     
     * <description>
     * Obtains the BrowserFieldConfig object by accessing the Screen.
     * @return <description>
     */
    ...
    /**
     * Version is retrieved based on the module itself - this should be set by tumbler
     * when building the app.  We don't want to retrieve 
     */
