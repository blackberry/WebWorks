...
/**
 * JavaScript function class - returns a lists of directories in the specified path
 * @author awong
 *
 */
public final class ListDirectoriesFunction extends ScriptableFunctionBase {

    public static final String NAME = "listDirectories";

    /**
     * Determine the name of directories that reside in a given directory.
     * 
     * @param args
