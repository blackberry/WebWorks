...
/**
 * Wrap a Scriptable. Used to help wrap a singleton in a unique object reference
 */
public class ScriptableWrapper extends Scriptable {
    private Scriptable _baseObject;

    /**
     * default constructor
     * @param baseObject the object to wrap
     */
    public ScriptableWrapper( Scriptable baseObject ) {
