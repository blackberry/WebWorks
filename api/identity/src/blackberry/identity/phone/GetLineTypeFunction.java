...
/**
 * Returns 1 if the line is mobile; 2 if PBX and 0 if neither.
 */
public final class GetLineTypeFunction extends PhoneFunctionBase {
    public static final String NAME = "getLineType";
    ...
    public Object invoke( final Object thiz, final Object[] args ) throws Exception {
        ...
        return new Integer( Phone.getLineType( lineId ) );
    }
}
