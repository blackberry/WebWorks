...
/**
 * Interface describes implementation for test.
 */
public interface TestableScriptableObject {

    /**
     * Use this interface if you wish to implement your custom testing rules.
     * 
     * @param object
     *            the ScriptableObjectBase object.
     * @return the boolean result of the test performed on object provided.
     */
    public boolean test( ScriptableObjectBase object );
}
