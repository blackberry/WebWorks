...
/**
 * The TaskArgumentsConstructor class is used to create new TaskArgumentsObject object.
 * 
 * @author sgolod
 * 
 */
public class TaskArgumentsConstructor extends ScriptableFunctionBase {
    public static final String NAME = "TaskArguments";
    ...
    protected FunctionSignature[] getFunctionSignatures() {
        ...
        fs.addParam( TaskObject.class, false );
