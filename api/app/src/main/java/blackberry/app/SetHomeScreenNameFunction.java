...
/**
 * Implements blackberry.app.setHomeScreenName 
 */
public final class SetHomeScreenNameFunction extends ScriptableFunctionBase {

    public static final String NAME = "setHomeScreenName";

    /**
     * @see ScriptableFunctionBase#execute(Object, Object[])
     */
    public Object execute( Object thiz, Object[] args ) throws Exception {
        HomeScreen.setName( args[ 0 ].toString() );
        return UNDEFINED;
    }
