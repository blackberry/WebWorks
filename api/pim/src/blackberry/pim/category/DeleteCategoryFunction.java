...
/**
 * This class implements the the delete category functionality
 * 
 * @author dmateescu
 * 
 */
public final class DeleteCategoryFunction extends ScriptableFunctionBase {

    public static final String NAME = "deleteCategory";

    /**
     * Delete the specified category to the PIM database
     * 
     * @param thiz
