...
public class SystemNamespace extends Scriptable {
    ...
    public static final String SRIPT_API_VERSION = "scriptApiVersion";
    ...
    public SystemNamespace() {
        ...
        _fields.put( SOFTWARE_VERSION, softwareVersion );
        _fields.put( SRIPT_API_VERSION, softwareVersion );
