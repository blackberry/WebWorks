...
(function () {
	function Payment(disp) {
		/*
        * Define public static function blackberry.payment.purchase() & blackberry.payment.getExistingPurchases()
        */
		...
		/*
		 * Getters & Setters for public static properties
		 */
		this.constructor.prototype.__defineGetter__("developmentMode", disp.getDevelopmentMode);
		this.constructor.prototype.__defineSetter__("developmentMode", disp.setDevelopmentMode);
	};
